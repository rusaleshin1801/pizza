...
var useDynamicList = function useDynamicList() {
  ...
  var insert = (0, _react.useCallback)(function (index, item) {
    setList(function (l) {
      var temp = (0, _toConsumableArray2["default"])(l);
  ...
  var merge = (0, _react.useCallback)(function (index, items) {
    setList(function (l) {
      ...
      temp.splice.apply(temp, [index, 0].concat((0, _toConsumableArray2["default"])(items)));
      return temp;
    });
  }, []);
  ...
  var move = (0, _react.useCallback)(function (oldIndex, newIndex) {
    ...
    setList(function (l) {
      var newList = (0, _toConsumableArray2["default"])(l);
